...
extern struct gli_matrix_stack modelview_ms, projection_ms;
...
int gli_matrix_stack_ctor(struct gli_matrix_stack *mt, unsigned size);
void gli_matrix_stack_dtor(struct gli_matrix_stack *mt);
