...
static gpuCmdVector vectors[sizeof_array(vec3d)] = {
	{ .same_as = 0, .u = { .text = { .u=0, .v=0, .i=125<<16, .z=0 }, }, },
	{ .same_as = 0, .u = { .text = { .u=3<<16, .v=0, .i=0<<16, .z=0 }, }, },
	{ .same_as = 0, .u = { .text = { .u=3<<16, .v=3<<16, .i=125<<16, .z=0 }, }, },
	{ .same_as = 0, .u = { .text = { .u=0, .v=3<<16, .i=250<<16, .z=0 }, }, },
